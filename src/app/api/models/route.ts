...
const KIE_MODELS: ProviderModel[] = [
  ...
  {
    id: "fal-ai/kling-video/v3.0/standard/motion-control",
...
export async function GET(
  ...
  if (providerFilter) {
    if (providerFilter === "gemini") {
      ...
      // Only Kie requested - include hardcoded Kie models for listing even without an API key
      includeKie = true;
  ...
  includeKie = true; // Always include hardcoded Kie models for listing
    if (wavespeedKey) {
