...
describe("nodeDefaults utilities", () => {
  ...
  describe("createDefaultNodeData", () => {
    ...
    it("creates correct structure for crop", () => {
      const data = createDefaultNodeData("crop");

      expect(data).toHaveProperty("inputImages");
      expect(data).toHaveProperty("outputImage", null);
      expect(data).toHaveProperty("aspectRatio", "original");
      expect(data).toHaveProperty("x", 0);
      expect(data).toHaveProperty("y", 0);
      expect(data).toHaveProperty("width", 100);
      expect(data).toHaveProperty("height", 100);
      expect(data).toHaveProperty("status", "idle");
      expect(data).toHaveProperty("error", null);
    });

    it("creates correct structure for resize", () => {
      const data = createDefaultNodeData("resize");

      expect(data).toHaveProperty("inputImages");
      expect(data).toHaveProperty("outputImage", null);
      expect(data).toHaveProperty("width", 1024);
      expect(data).toHaveProperty("height", 1024);
      expect(data).toHaveProperty("keepAspectRatio", true);
      expect(data).toHaveProperty("status", "idle");
      expect(data).toHaveProperty("error", null);
    });

    it("creates correct structure for upscale", () => {
      const data = createDefaultNodeData("upscale");

      expect(data).toHaveProperty("inputImages");
      expect(data).toHaveProperty("outputImage", null);
      expect(data).toHaveProperty("model", "Standard V2");
      expect(data).toHaveProperty("upscaleFactor", 2);
      expect(data).toHaveProperty("faceEnhancement", true);
      expect(data).toHaveProperty("subjectDetection", "All");
      expect(data).toHaveProperty("status", "idle");
      expect(data).toHaveProperty("error", null);
    });

    it("creates correct structure for removeBg", () => {
      const data = createDefaultNodeData("removeBg");

      expect(data).toHaveProperty("inputImages");
      expect(data).toHaveProperty("outputImage", null);
      expect(data).toHaveProperty("model", "General Use (Light)");
      expect(data).toHaveProperty("operatingResolution", "1024x1024");
      expect(data).toHaveProperty("refineForeground", true);
      expect(data).toHaveProperty("status", "idle");
      expect(data).toHaveProperty("error", null);
    });
