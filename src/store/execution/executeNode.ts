...
import { executeCrop, executeResize, executeUpscale, executeRemoveBg } from "./imageTransformExecutors";
...
export async function executeNode(
  ...
  switch (ctx.node.type) {
    ...
    case "annotation":
      ...
      break;
    case "crop":
      await executeCrop(ctx, regenOpts);
      break;
    case "resize":
      await executeResize(ctx, regenOpts);
      break;
    case "upscale":
      await executeUpscale(ctx, regenOpts);
      break;
    case "removeBg":
      await executeRemoveBg(ctx, regenOpts);
      break;
    case "prompt":
