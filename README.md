...
[Discord](https://discord.com/invite/89Nr6EKkTf)
...
Kivo is a node-based workflow editor for AI media generation. Drag nodes onto an infinite canvas, connect them with typed handles, and execute pipelines that call AI APIs in dependency order.
...
```bash
git clone https://github.com/matheuseabra/kivo.git
cd kivo
npm install
npm run dev
```
...
- **[GitHub Issues](https://github.com/matheuseabra/kivo/issues)** — Report bugs and request features
